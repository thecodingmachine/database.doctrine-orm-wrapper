...
MoufUtils::registerChooseInstanceMenuItem('dbDoctrineGenerateDAOAdminSubMenu', 'Configure DAOs', 'entityManagerInstall/', "Mouf\\Doctrine\\ORM\\MoufEntityManagerInterface", 'dbDoctrineAdminSubMenu', 10);
MoufUtils::registerChooseInstanceMenuItem('dbDoctrineUpdateSchemaAdminSubMenu', 'Update schema and DAOs', 'entityManagerInstall/generate_schema', "Mouf\\Doctrine\\ORM\\MoufEntityManagerInterface", 'dbDoctrineAdminSubMenu', 20);
