...
MoufUtils::registerChooseInstanceMenuItem('dbDoctrineGenerateDAOAdminSubMenu', 'Configure DAOs', 'entityManagerInstall/', "Mouf\\Doctrine\\ORM\\MoufResetableEntityManager", 'dbDoctrineAdminSubMenu', 10);
MoufUtils::registerChooseInstanceMenuItem('dbDoctrineUpdateSchemaAdminSubMenu', 'Update schema and DAOs', 'entityManagerInstall/generate_schema', "Mouf\\Doctrine\\ORM\\MoufResetableEntityManager", 'dbDoctrineAdminSubMenu', 20);
